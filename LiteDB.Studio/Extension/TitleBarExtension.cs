namespace LiteDB.Studio.Extension
{
    using LiteDB.Studio.Classes;
    using System;
    using System.Windows.Forms;

    public static class TitleBarExtension
    {
        ...
        public static bool EnabledTitleBarDarkMode(this Form form, bool enabled = true)
        {
            return EnabledDarkTheme(form.Handle, enabled);
        }

        private static bool EnabledDarkTheme(IntPtr handle, bool enabled)
        {
